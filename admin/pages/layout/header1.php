...
<header style="margin-bottom:0px:>
	...
	<nav class="navbar1">
		<ul>
			<li><a href="https://mabisamercadodentalclinic.000webhostapp.com/admin/admin.php?page=dashboard">Home</a></li>
			<li><a href="#">Dentist Administration</a>
					<ul>
						<li><a href="../pages/admin_reg.php">Registration</a></li>
						<li><a href="https://mabisamercadodentalclinic.000webhostapp.com/pages/email.php">Forgot&nbsp;Password</a></li>
            ...
            <li><a href="../pages/patient_qr_code_loss.php">QR Code Scan</a></li>
            <li><a href="https://mabisamercadodentalclinic.000webhostapp.com/pages/qr-code-loss.php">QR Code Loss</a></li>
					</ul>
			</li>
			...
			<li><a href="?page=reports-list">Reports</a>
					<ul>
						<li><a href="../pages/reports.php">Evaluation</a></li>
